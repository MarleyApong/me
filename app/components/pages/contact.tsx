...
export function ContactPage({ lang }: ContactProps) {
  ...
  return (
    <div className="contact-page">
      <div className="contact-left">
        ...
        <h2 className="contact-headline anim-in" style={{ "--d": "200ms" } as React.CSSProperties}>
          {t.headline1}<br />
          <span className="emph">{t.headline2}</span>
        </h2>
        <a
          className="contact-mailto anim-in"
          style={{ "--d": "600ms" } as React.CSSProperties}
          href={`mailto:${t.mailto}`}
        >
          <span>{t.cta} →</span>
        </a>
        <div className="contact-sig anim-in" style={{ "--d": "900ms" } as React.CSSProperties}>
          · {t.sig}
        </div>
      </div>
      ...
      <div className="contact-right">
        {t.links.map((l, i) => (
          <a
            key={i}
            className="contact-link anim-in"
